...
const afdianNotes = path.join(repoRoot, 'docs', `AFDIAN-P-LAUNCH-v${packageInfo.version}.md`)
copy(
  fs.existsSync(afdianNotes)
    ? afdianNotes
    : path.join(repoRoot, 'docs', 'AFDIAN-P-LAUNCH-2026-07-26.md'),
  '爱发电发布文案.md',
)
